 ...
 */
CommunityRole = new Roles.Role('nurse');
 ...
 */
CommunityRole.allow('collections.treatmentplans1.index', true);

/**
 * And we will make that the users only see their posts in the index
 */
CommunityRole.helper('collections.treatmentplans1.indexFilter', function() {
 ...
 */
CommunityRole.allow('collections.treatmentplans1.insert', true);

/**
 * Users can update posts
 */
CommunityRole.allow('collections.treatmentplans1.update', function(userId, doc, fields, modifier) {
 ...
 */
CommunityRole.deny('collections.treatmentplans1.update', function(userId, doc, fields, modifier) {
 ...
 */
CommunityRole.allow('collections.treatmentplans1.remove', function(userId, doc) {
  return doc.createdBy === userId; // Will be allowed to edit his own posts
});
 ...
 */
CommunityRole.allow('collections.treatmentplans1.showCreate', true);

/**
 * Users can see the update post button if they created the doc
 */
CommunityRole.allow('collections.treatmentplans1.showUpdate', function(doc) {
 ...
 */
CommunityRole.allow('collections.treatmentplans1.showRemove', function(doc) {
  return doc.createdBy == this.userId;
});